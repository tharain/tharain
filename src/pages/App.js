              ...
              {portfolioData.map(tile => (
                ...
                >
                  ...
                  <GridListTileBar
                    ...
                    className="pointer"
                    title={tile.title}
                    subtitle={<span>{tile.tooltip} [{tile.author}]</span>}
                    actionIcon={
                      <Tooltip
                        title={tile.title}
                        placement="top"
    ...
    return this.state.page === 'Work' ? (
      <React.Fragment>
        <ExpansionPanel defaultExpanded>
          ...
          >
            <img src="./assets/shopee_logo.svg" alt="shopee logo" className={classes.logo} />
            <br />
        ...
        <ExpansionPanel defaultExpanded>
          ...
          >
            <img src="./assets/HP_logo.svg" alt="hp logo" className={classes.logo} />
            <br />
        ...
        <ExpansionPanel defaultExpanded>
          ...
          >
            <img src="./assets/astar_logo.svg" alt="astar logo" className={classes.logo} />
            <br />
